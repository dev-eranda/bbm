                  ...
                  <div className="content-wrap">
                    ...
                    <div className="the-contents">
                      <div className="summery-wrap">
                        <h6>Here is your summary of your workout</h6>
                        <div className="workout-box-wrap">
                          <Container>
                            <Row>
                              <Col lg={5} md={12}>
                                <div className="workout-box w-loss">
                                  <div className="workout-col1">
                                    <h5>Weight Loss</h5>
                                    <h6>20Kg</h6>
                                  </div>
                                ...
                                <div className="workout-box t-archived">
                                  <div className="workout-col1">
                                    <h5>Target Archived</h5>
                                    <h6>48%</h6>
                                  </div>
                                  <div className="workout-chart">
                                    chart module
                                ...
                                <div className="workout-box s-time">
                                  <div className="workout-col1">
                                    <h5>Sleep Time</h5>
                                  </div>
                                  <div className="workout-chart">
                              ...
                              <Col lg={7} md={12}>
                                <div className="workout-box w-summary">
                                  <div className="workout-col1">
                                ...
                                <div className="workout-box water-intake">
                                  <div className="workout-col1">
                                    <h5>Total Water Intake</h5>
                                    <h6>25</h6>
                                    <span className="box-subtitle">Liters</span>
                                  </div>
                                </div>
                                <div className="workout-box breathing">
                                  <div className="workout-col1">
                                    <h5>Breathing</h5>
                                    <h6>15</h6>
                                    <span className="box-subtitle">Minutes</span>
                                  </div>
                                </div>
                              </Col>
                            </Row>
