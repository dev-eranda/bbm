                      ...
                      <div className="summery-wrap inner">
                        <div className="breadcrumb-wrap">
                          <Breadcrumb>
                            ...
                            <Breadcrumb.Item href="">Sleep/Wake</Breadcrumb.Item>
                          </Breadcrumb>
                        </div>
                                ...
                                <div className="content-box  p-0">
                                  <div className="contents-wrapper">
                                    <div className="today-workout-wrap">
                                      <div className="tab-wrapper weight">
                                        <Tabs defaultActiveKey="intro" id="">
                                          <Tab eventKey="intro" title="Introduction">
                                            <TabContent>
                                            intro text
                                            </TabContent>
                                          </Tab>
                                          <Tab eventKey="sleep-history" title="Sleep History">
                                            <TabContent>
                                            Chart module
                                            </TabContent>
                                          </Tab>
                                          <Tab eventKey="rec-time" title="Record Time">
                                            <TabContent>
                                            <div className="sleepwake">
                                              <div className="sleep-wrap">
                                              <Form.Control type="text" placeholder="" value="15" />
                                              <Form.Label>Hours</Form.Label>
                                              </div>
                                              <div className="wake-wrap">
                                              <Form.Control type="text" placeholder="" value="8" />
                                              <Form.Label>Hours</Form.Label>
                                              </div>
                                             
                                              
                                            </div>
                                            <div className="cup-req-text sw-wrap">
