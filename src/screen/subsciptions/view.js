...
import meal_monthly from '../../assets/images/premium-quality-monthly.png';
import meal_annualy from '../../assets/images/premium-quality-annualy.png';
                      ...
                      <div className="summery-wrap inner">
                        <div className="breadcrumb-wrap">
                          <Breadcrumb>
                            ...
                            <Breadcrumb.Item href="">Subsciptions</Breadcrumb.Item>
                          </Breadcrumb>
                        </div>
                        <div className="content-box-wrap my-goal ">
                          <Container>
                            <Row>
                              ...
                              <Col md={12}>
                                <div className="content-box no-bg p-0">
                                  <div className="contents-wrapper">
                                    <div className="today-workout-wrap subs">
                                      <div className="subscription-wrap">
                                        <Row>
                                          <Col md={6}>
                                            <div className="subscribe month">
                                              <div className="sublogo-wrap">
                                                <img src={meal_monthly} className="img-fluid" />
                                              </div>
                                              <div className="sub-title">
                                                <h3>Monthly Subscription</h3>
                                              </div>
                                              <div className="subfee-wrap">
                                                <span className="sub-currentcy">AUD</span>
                                                <div className="subfee">
                                                  <h4>10.00</h4><span className="subseperate">/</span>Monthly
                                                </div>
                                          ...
                                          <Col md={6}>
                                            <div className="subscribe annual">
                                              <div className="sublogo-wrap">
                                                <img src={meal_annualy} className="img-fluid" />
                                              </div>
                                              <div className="sub-title">
                                              ...
                                              <div className="subfee-wrap">
                                                <span className="sub-currentcy">AUD</span>
                                                <div className="subfee">
                                                  <h4>97.00</h4><span className="subseperate">/</span>Yearly
                                                </div>
                                                <p>You will have access to all features of the APP for 31 Days</p>
                                                <button className="btn-subscribe">Subscribe Now</button>
                                              </div>
