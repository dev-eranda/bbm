                      ...
                      <div className="summery-wrap inner">
                        <div className="breadcrumb-wrap">
                          <Breadcrumb>
                            ...
                            <Breadcrumb.Item href="">Weight</Breadcrumb.Item>
                          </Breadcrumb>
                        </div>
                                  ...
                                  <div className="contents-wrapper">
                                    <div className="today-workout-wrap">
                                      <div className="tab-wrapper weight">
                                        <Tabs defaultActiveKey="w-history" id="">
                                          <Tab eventKey="w-history" title="Weight History">
                                            <TabContent>
                                            Chart module
                                            </TabContent>
                                          </Tab>
                                          <Tab eventKey="rt-weight" title="Record Today's Weight">
                                            <TabContent>
                                            ...
                                            <div className="cup-req-text weight">
                                              <div className="pilltext">
                                                <h5>Kilograms</h5>
                                              </div>
                                              <div className="pillbtn-wrap">
                                                  <button className="btn-submitime">Submit Weight</button> 
                                              </div>
